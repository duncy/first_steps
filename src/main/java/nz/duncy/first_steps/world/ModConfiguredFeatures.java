...
public class ModConfiguredFeatures {
    ...
    //public static final RegistryKey<ConfiguredFeature<? ,?>> ALUNITE_ORE_KEY = registerKey("alunite_ore");
    ...
    public static void boostrap(Registerable<ConfiguredFeature<?, ?>> context) {
        ...
        //List<OreFeatureConfig.Target> overworldAluniteOres =
        //    List.of(OreFeatureConfig.createTarget(stoneReplacables, ModBlocks.STONE_ALUNITE_ORE.getDefaultState()));
        ...
        //register(context, ALUNITE_ORE_KEY, Feature.ORE, new OreFeatureConfig(overworldAluniteOres, 12));
