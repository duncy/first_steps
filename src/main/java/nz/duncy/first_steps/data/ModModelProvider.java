package nz.duncy.first_steps.data;
...
public class ModModelProvider extends FabricModelProvider {
    ...
    public void generateItemModels(ItemModelGenerator itemModelGenerator) {
        ...
        registerNonLeatherArmorWithoutTrims(itemModelGenerator, ModItems.ARMING_CAP, ModArmorMaterials.PADDED_CLOTH_ARMOR_MATERIAL, "helmet", true);
        registerNonLeatherArmorWithoutTrims(itemModelGenerator, ModItems.GAMBESON, ModArmorMaterials.PADDED_CLOTH_ARMOR_MATERIAL, "chestplate", true);
        registerNonLeatherArmorWithoutTrims(itemModelGenerator, ModItems.CLOTH_CHAUSSES, ModArmorMaterials.PADDED_CLOTH_ARMOR_MATERIAL, "leggings", true);
        registerLeatherArmorWithoutTrims(itemModelGenerator, ModItems.TURNSHOES, ArmorMaterials.LEATHER, "boots", true);

        registerNonLeatherArmorWithoutTrims(itemModelGenerator, ModItems.COPPER_CHAINMAIL_COIF, ArmorMaterials.CHAIN, "helmet", false);
        registerNonLeatherArmorWithoutTrims(itemModelGenerator, ModItems.COPPER_CHAINMAIL_HAUBERK, ArmorMaterials.CHAIN, "chestplate", false);
        registerNonLeatherArmorWithoutTrims(itemModelGenerator, ModItems.COPPER_CHAINMAIL_CHAUSESS, ArmorMaterials.CHAIN, "leggings", false);
        registerNonLeatherArmorWithoutTrims(itemModelGenerator, ModItems.COPPER_CHAINMAIL_FOOTINGS, ArmorMaterials.CHAIN, "boots", false);

        registerNonLeatherArmorWithoutTrims(itemModelGenerator, ModItems.BRONZE_CHAINMAIL_COIF, ArmorMaterials.CHAIN, "helmet", false);
        registerNonLeatherArmorWithoutTrims(itemModelGenerator, ModItems.BRONZE_CHAINMAIL_HAUBERK, ArmorMaterials.CHAIN, "chestplate", false);
        registerNonLeatherArmorWithoutTrims(itemModelGenerator, ModItems.BRONZE_CHAINMAIL_CHAUSESS, ArmorMaterials.CHAIN, "leggings", false);
        registerNonLeatherArmorWithoutTrims(itemModelGenerator, ModItems.BRONZE_CHAINMAIL_FOOTINGS, ArmorMaterials.CHAIN, "boots", false);

        registerNonLeatherArmorWithoutTrims(itemModelGenerator, ModItems.IRON_CHAINMAIL_COIF, ArmorMaterials.CHAIN, "helmet", false);
        registerNonLeatherArmorWithoutTrims(itemModelGenerator, ModItems.IRON_CHAINMAIL_HAUBERK, ArmorMaterials.CHAIN, "chestplate", false);
        registerNonLeatherArmorWithoutTrims(itemModelGenerator, ModItems.IRON_CHAINMAIL_CHAUSESS, ArmorMaterials.CHAIN, "leggings", false);
        registerNonLeatherArmorWithoutTrims(itemModelGenerator, ModItems.IRON_CHAINMAIL_FOOTINGS, ArmorMaterials.CHAIN, "boots", false);
    }
    ...
    public final void registerNonLeatherArmorWithoutTrims(ItemModelGenerator itemModelGenerator, Item item, ArmorMaterial armorMaterial, String type, boolean dyeable) {
		Identifier identifier = ModelIds.getItemModelId(item);
		Identifier baseTextureIdentifier = TextureMap.getId(item);
		Identifier overlayTextureIdentifier = TextureMap.getSubId(item, "_overlay");

		ItemModel.Unbaked unbaked;
		if (dyeable) {
			Models.GENERATED_TWO_LAYERS.upload(identifier, TextureMap.layered(baseTextureIdentifier, overlayTextureIdentifier), itemModelGenerator.modelCollector);
			unbaked = ItemModels.basic(identifier);
		} else {
			Models.GENERATED.upload(identifier, TextureMap.layer0(baseTextureIdentifier), itemModelGenerator.modelCollector);
			unbaked = ItemModels.basic(identifier);
		}
    ...
    public final void registerLeatherArmorWithoutTrims(ItemModelGenerator itemModelGenerator, Item item, ArmorMaterial armorMaterial, String type, boolean dyeable) {
        Identifier identifier = ModelIds.getItemModelId(item);
        Identifier baseTextureIdentifier = TextureMap.getId(item);
        Identifier overlayTextureIdentifier = TextureMap.getSubId(item, "_overlay");
