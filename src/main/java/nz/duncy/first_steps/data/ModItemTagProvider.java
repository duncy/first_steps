...
public class ModItemTagProvider extends FabricTagProvider.ItemTagProvider {
    ...
    protected void configure(RegistryWrapper.WrapperLookup arg) {
        ...
        getOrCreateTagBuilder(ModTags.Items.BASE_LAYER_ARMOR)
            .add(ModItems.ARMING_CAP)
            .add(ModItems.GAMBESON)
            .add(ModItems.CLOTH_CHAUSSES)
            .add(ModItems.TURNSHOES)
            .add(ModItems.LEATHER_JERKIN);

        getOrCreateTagBuilder(ModTags.Items.MID_LAYER_ARMOR)
            .add(ModItems.COPPER_CHAINMAIL_COIF)
            .add(ModItems.BRONZE_CHAINMAIL_COIF)
            .add(ModItems.IRON_CHAINMAIL_COIF)
            .add(ModItems.COPPER_CHAINMAIL_HAUBERK)
            .add(ModItems.BRONZE_CHAINMAIL_HAUBERK)
            .add(ModItems.IRON_CHAINMAIL_HAUBERK)
            .add(ModItems.COPPER_CHAINMAIL_CHAUSESS)
            .add(ModItems.BRONZE_CHAINMAIL_CHAUSESS)
            .add(ModItems.IRON_CHAINMAIL_CHAUSESS)
            .add(ModItems.COPPER_CHAINMAIL_FOOTINGS)
            .add(ModItems.BRONZE_CHAINMAIL_FOOTINGS)
            .add(ModItems.IRON_CHAINMAIL_FOOTINGS);
